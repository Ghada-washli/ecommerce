...
export default function Footer() {
    return (
        <>
            <footer className="w-full bg-main-color mt-10 z-[300] fixed bottom left-0 right-0 ">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">

                    <div className="py-16 flex justify-between items-center flex-col gap-8 lg:flex-row">
                        <a href="" className="flex items-center space-x-2 rtl:space-x-reverse">
                            <img src={logo} className="h-12 w-fit" alt="Flowbite Logo" />
                            <span className="self-center text-xl font-semibold whitespace-nowrap text-white">online Shop</span>
                        </a>
                        <ul className="text-lg text-center sm:flex items-cente justify-center gap-14 lg:gap-10 xl:gap-14 transition-all duration-500">
                            <li className="sm:my-0 my-2"><a href="javascript:;" className="text-white hover:text-gray-400">Home</a></li>

                            <li><a href="javascript:;" className="text-white hover:text-gray-400">Products</a></li>
                            <li className="sm:my-0 my-2"><a href="javascript:;" className="text-white hover:text-gray-400">Brands</a></li>
                            <li><a href="javascript:;" className="text-white hover:text-gray-400">Categories</a></li>
                            <li><a href="javascript:;" className="text-white hover:text-gray-400">Cart</a></li>
                        </ul>
                        <div className="flex  space-x-4 sm:justify-center  ">
                            <a href="javascript:;" className="w-9 h-9 rounded-full bg-[#343435] flex justify-center items-center">
                    ...
                    <div className="py-7 border-t border-gray-700">
                        <div className="flex items-center justify-center">
                            <span className="text-gray-400 ">©<a href="">Ghada</a>2024, All rights reserved.</span>
                        </div>
                    </div>
                </div>
            </footer>
